...
const BottomBanner = () => {
  return (
    <div className='relative mt-24'>
      ...
      <div className='absolute inset-0 flex flex-col items-center md:items-end md:justify-center pt-16 md:pt-0 md:pr24'>
        <div className='hidden md:block w-2/5 bg-white/80 backdrop-blur-md p-6 rounded-lg'>
